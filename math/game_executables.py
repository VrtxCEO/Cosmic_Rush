...
class GameExecutables(GameCalculations):
    """Game dependent grouped functions for Star Gazing."""
    ...
    def update_grid_mults(self):
        """All positions start deactivated (0). First win activates to 1x.
        Subsequent wins on the same position increment by 1, capped at maximum_board_mult."""
    ...
    def get_clusters_update_wins(self):
        ...
        clusters = GameCalculations.get_clusters_shared_wilds(self.board, "wild")
        return_data = {
            "totalWin": 0,
            "wins": [],
        }
