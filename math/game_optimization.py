"""Set conditions/parameters for optimization program for Star Gazing

Distribution criteria per bonus type:
- freegame_cosmic_break: 4 SUN → 8x8, locked corners + progressive multiplier
"""
        ...
        self.game_config.opt_params = {
            "base": {
                "conditions": {
                    ...
                    "freegame_cosmic_break": ConstructConditions(
                        rtp=0.15, hr=500, search_conditions={"symbol": "scatter"}
                    ).return_dict(),
                    "basegame": ConstructConditions(hr=3.5, rtp=0.81).return_dict(),
                },
